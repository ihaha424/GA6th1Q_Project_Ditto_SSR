...
void Boss_01_Scene::Initialize()
{
}

void Boss_01_Scene::Finalize()
{
}
void Boss_01_Scene::Enter()
{

	//1StageBGM
	ResourceManager::GetInstance()->PlayMusic(game::eSoundList::BGM, 5, game::eSoundChannel::BGM);
	...
	// 보스
	BossObject* Boss = new BossObject(this, 1);
...
Boss_01_Scene::Boss_01_Scene()
	:SceneBase("Boss_01_Scene")
{}
