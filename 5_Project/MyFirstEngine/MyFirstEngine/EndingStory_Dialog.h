...
class EndingStory_Dialog : public GameObject
{

public:
	TypingTextUIScript* myScript;

	EndingStory_Dialog(SceneBase* Scene) : GameObject("EndingStory_Dialog", Scene)
	{
		...
		//{
		//	myScript->m_tSoundList.push_back(game::eSoundList::test);
		//}
...
//		};
		...
		//myScript->SetRectSizeAndTransform(1920, 1080, 400, 200);
