...
void Boss_03_Scene::Initialize()
{

}

void Boss_03_Scene::Finalize()
{

}

void Boss_03_Scene::Enter()
{
	//3StageBGM
	ResourceManager::GetInstance()->PlayMusic(game::eSoundList::BGM, 7, game::eSoundChannel::BGM);
...
Boss_03_Scene::Boss_03_Scene() :SceneBase("Boss_03_Scene")
{

}

Boss_03_Scene::~Boss_03_Scene()
{
