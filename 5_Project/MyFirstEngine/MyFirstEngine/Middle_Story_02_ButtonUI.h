...
class Middle_Story_02_ButtonUI : public ButtonGameObject
{
public:
	Middle_Story_02_ButtonUI(SceneBase* Scene) : ButtonGameObject("Middle_Story_02_ButtonUI", Scene)
	{
		//이미지 설정
	...
	virtual ~Middle_Story_02_ButtonUI() {};

	void OnClick() override
	{
		Observer::GetInstance()->m_GameFlag = game::SCENE_TYPE::SHIP_DIRECTING_BOSS_03;
	}
};
